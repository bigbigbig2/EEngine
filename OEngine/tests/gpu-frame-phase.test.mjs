...
test("GPU phase classifier covers current main-frame labels without hiding unknowns", () => {
  const cases = new Map([
    ...
    ["Packed VisibilityKey/depth exact drawIndirect", "hardware-raster"],
    ["HZB/build_mip4", "hzb"],
    ...
    ["MaterialKernel/prepare class ranges and indirect draws", "material-resolve"],
    ["MaterialKernel/scatter ShadeWork", "material-resolve"],
    ["MaterialKernel/publish sampled counters", "observability"],
