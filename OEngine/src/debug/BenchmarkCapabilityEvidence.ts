...
export const BENCHMARK_GPU_COUNTER_EVIDENCE = {
  ...
  setupVisiblePixelHits: supported("SparseShading specialized resolve/TriangleSetup evidence compute"),
  setupVisiblePixelFallbacks: supported("SparseShading specialized resolve/per-pixel fallback evidence compute"),
