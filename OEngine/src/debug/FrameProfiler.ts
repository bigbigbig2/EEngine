...
const KNOWN_RUNTIME_METRIC_IDS = Object.freeze([
  ...
  "ao.historyValid",
  "ao.internalPixels",
  "ao.bentNormalBytesPerPixel",
  "ao.finalVisibilityBytesPerPixel",
  "ao.momentsBytesPerPixel",
  "ao.pixels",
  "ao.rawPasses",
  "ao.spatialPasses",
  "ao.temporalPasses",
  "ao.traceDepthSamplesPerPixel",
  ...
  "packed.geometry.allocatedBytes",
  "packed.geometry.logicalBytes",
  "packed.geometry.residentAssets",
  "packed.geometry.residentBytes",
  "packed.geometry.retiringBytes",
  ...
  "packed.instance.cpuDynamicShadowBytes",
  "packed.instance.cpuShadowBytes",
  "packed.instance.cpuStaticShadowBytes",
  "packed.instance.dynamicRecordStride",
  "packed.instance.materialPatchBytes",
  "packed.instance.recordStride",
  "packed.instance.staticPatchBytes",
  "packed.instance.staticRecordStride",
  "packed.instance.transformPatchBytes",
  "packed.instance.visibilityPatchBytes",
  ...
  "sharedPyramid.allocatedBytes",
  "sharedPyramid.bloomConsumedMips",
  "sharedPyramid.bloomReconstructPasses",
  "sharedPyramid.exposureHistogramPasses",
  "sharedPyramid.exposureMeteringMip",
  "sharedPyramid.exposureMeteringPixels",
  "sharedPyramid.finalBuilds",
  "sharedPyramid.finalMips",
  "sharedPyramid.finalRenderPasses",
  "sharedPyramid.opaqueBuilds",
  "sharedPyramid.opaqueMips",
  "sharedPyramid.opaqueRenderPasses",
  "sharedPyramid.screenSpaceDiffuseSourceBuilds",
  "runtime.scenePrepareCount",
  "runtime.viewPrepareCount",
  "post.bloomFused",
  "post.colorGradingFused",
  "post.finalOutputPasses",
  "post.fullResolutionHdrIntermediates",
  "post.sharpeningFused",
  "shadow.atlasBytes",
  ...
  "sparseShading.demandHdr",
  "sparseShading.demandIndirectComponents",
  "sparseShading.demandLightingDebug",
  "sparseShading.demandMask",
  "sparseShading.demandShadowSampling",
  "sparseShading.demandSurface",
  "sparseShading.demandVelocity",
  "sparseShading.executionMode",
  "sparseShading.publishedBins",
  "sparseShading.internalPixels",
  "sparseShading.resolveRan",
  "sparseShading.heapBytes",
  "sparseShading.indirectBytes",
  "sparseShading.settingsBytes",
  "sparseShading.statusBytes",
