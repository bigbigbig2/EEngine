...
export class GraphicsContext {
  ...
  /** Lazily creates the authoritative Scene → GPU Render World owner. */
  ...
  /** Lazily creates the stable MaterialRecord owner. */
