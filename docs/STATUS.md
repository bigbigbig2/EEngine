...
2. [ADR-0009](./adr/0009-compute-shading-and-advanced-frame-pipeline-v2.md)：Step 0–3 已完成；下一项执行 Step 4 Three.js-derived GTAO replacement，保持 `mode=gtao` 独占 owner、共享 Depth/HZB/Velocity/History 合同和 feature-off 物理裁剪。
