...
2. [ADR-0009](./adr/0009-compute-shading-and-advanced-frame-pipeline-v2.md)：Step 0–2 已完成；Step 3 已完成 Surface V1/bridge/旧 ABI 权威删除、20/24 B compact working set、velocity pruning、8 B HDR ABI、semantic baseline cutover和 IBL/LPV/Brick4 SSR-off 物理裁剪，下一项取得 clean comprehensive PERF。
