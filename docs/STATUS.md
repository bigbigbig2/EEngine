...
2. [ADR-0009](./adr/0009-compute-shading-and-advanced-frame-pipeline-v2.md)：VisibilityKey V2 production cutover、ADR-0008 final PERF 与 `TextureBindingSetId` classification 已完成，可以进入 Step 0 的下一项。
