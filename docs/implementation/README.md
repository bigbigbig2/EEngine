...
R5-00、FX-01 Surface、FX-02 Clustered Direct、FX-03 IBL Alignment、G5-L与FX-04 Packed CSM Shadow已关闭。FX-04 clean commit `8986dc6`证明production hierarchy次级视图、三组有界Cascade RasterWork、单次逐cascade间接深度绘制、MASK caster、零overflow与feature on/off/on零残留；证据见`temp/r5/fx-04/8986dc6256e31a5c3630935d1fff2aed08f7a3bf/`。根`performance-targets.json`已冻结目标机器与产品/回归预算且明确产品目标尚未达成；当前唯一执行入口是FX-05 Packed MBOIT Transparency，G5-S仍未关闭，不重开FX-01..04。
