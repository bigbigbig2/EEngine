...
R5-00、FX-01 Surface、FX-02 Clustered Direct、FX-03 IBL Alignment、G5-L、FX-04 Packed CSM Shadow、FX-05 Packed MBOIT Transparency与G5-S已关闭。FX-04 clean commit `8986dc6`证明production hierarchy次级视图、三组有界Cascade RasterWork、单次逐cascade间接深度绘制、MASK caster、零overflow与feature on/off/on零残留；FX-05受测源码clean commit `ee576a5`证明BLEND分类、共享hierarchy、固定3 draw、真实sampled counter、零finite/overflow与提交顺序无关，证据分别见`temp/r5/fx-04/8986dc6256e31a5c3630935d1fff2aed08f7a3bf/`和`temp/r5/fx-05/ee576a574d0776b9d429c6befc240c3478e05528-dirty-bbb10831fccd/`。根`performance-targets.json`已冻结目标机器与产品/回归预算且明确产品目标尚未达成。当前主线进入FX-06A，不重开FX-01..05。
